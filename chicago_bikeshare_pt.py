...
answer = "Como valores para os gêneros temos: Male, Female e vazio ('').\n \
          O valor de len(data_list) é o somatório dos registros com valor Male, Female e vazio ('').\n \
          O valor de male + female não inclui os registros com valor vazio ('').\n \
          Portanto male + female será diferente de len(data_list)."
...
if len_list % 2 == 0:
    ...
    median_trip = sorted_list[int(len_list/2)]	
